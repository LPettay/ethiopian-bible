...
| `lexicon.json` | Generated word-gloss lexicon (format v2: shared `entries[]` + `words{surface: index}`), quoted verbatim from the Beta Masaheft Dillmann TEI data by `research/tools/build_lexicon_offline.py`. Regenerate, never hand-edit. CC BY-NC-SA 4.0. See ADR 0012. |
